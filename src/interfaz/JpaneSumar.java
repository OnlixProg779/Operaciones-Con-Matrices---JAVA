...
public class JpaneSumar extends JPanel {
	...
	public JpaneSumar() {
		...
		btnSumar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				matrizResultante = MatricesMetodos.sumarDosMatrices(matrizA, matrizB,pase);
		...
		btnSumar.setBounds(336, 101, 53, 48);
		panel.add(btnSumar);
		...
		scrollPane_2.setBounds(10, 36, 305, 175);
		...
		scrollPane_3.setBounds(412, 36, 305, 175);
		...
		checkBoxFraccion.setBounds(321, 71, 86, 23);
		panel.add(checkBoxFraccion);
		
		label = new JLabel("Suma de Matrices");
		label.setHorizontalAlignment(SwingConstants.CENTER);
		label.setFont(new Font("Sitka Text", Font.BOLD, 16));
		label.setBounds(278, 0, 167, 36);
		panel.add(label);
